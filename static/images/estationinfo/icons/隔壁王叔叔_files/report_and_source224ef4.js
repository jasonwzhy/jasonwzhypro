...
function n(t,e){
i("http://mp.weixin.qq.com/mp/ad_report?action=follow&type="+t+e.report_param);
}
function a(t){
var a=t.btn;
if(!a)return!1;
var i={},_=t.adData,f="",u="";
if("104"==_.pt){
var g=_.androiddownurl;
if(g&&g.match){
var v=/&channelid\=([^&]*)/,b=g.match(v);
b&&b[1]&&(f="&channelid="+b[1],_.androiddownurl=g.replace(v,""));
}
...
var a=n.lastIndexOf("_")+1,o=n.substring(a);
1*o>=m&&n.indexOf("get_install_state:yes")>-1&&(c=!0);
}),l.invoke("getInstallState",{
packageName:_.pkgname
},function(t){
var n=t.err_msg;
e("getInstallState @"+_.pkgname+" : "+n);
var o=n.lastIndexOf("_")+1,i=n.substring(o);
1*i>=_.versioncode&&n.indexOf("get_install_state:yes")>-1&&(d=!0,a.innerHTML="已安装",
p.removeClass(a,"btn_download"),p.addClass(a,"btn_installed"));
})),o.on(a,"click",function(){
if(e("click @js_app_action"),d&&"104"==_.pt)return!1;
var a=function(){
if("104"==_.pt)return c?(n(24,t),void(location.href="tmast://download?oplist=1;2&pname="+_.pkgname+f+u)):(n(25,t),
...
if("103"==_.pt){
n(23,t);
var e="http://"+location.host+"/mp/redirect?url="+encodeURIComponent(_.appinfo_url);

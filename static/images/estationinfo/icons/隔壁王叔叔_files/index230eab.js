...
for(var t,n=document.getElementsByTagName("iframe"),i=0,o=n.length;o>i;++i){
t=n[i];
var c=t.getAttribute("data-src"),d=t.className||"";
c&&(0==c.indexOf("http://mp.weixin.qq.com/mp/appmsgvote")&&d.indexOf("js_editor_vote_card")>=0||0==c.indexOf("http://mp.weixin.qq.com/bizmall/appmsgcard")&&d.indexOf("card_iframe")>=0)&&(d.indexOf("card_iframe")>=0?t.setAttribute("src",c.replace("#wechat_redirect",["&uin=",uin,"&key=",key,"&scene=",source,"&msgid=",appmsgid,"&msgidx=",itemidx||idx,"&version=",version,"&devicetype=",window.devicetype||""].join(""))):t.setAttribute("src",c.replace("#wechat_redirect",["&uin=",uin,"&key=",key].join(""))),
function(t){
t.onload=function(){
e(t);
};
...
},"getElementsByClassName"in document)for(var m,r=document.getElementsByClassName("video_iframe"),i=0;m=r.item(i++);)m.setAttribute("scrolling","no"),
...
n||(n=1),o||(o="Like"),parseInt(n)>1e5?n="100000+":"",parseInt(o)>1e5?o="100000+":"",
...
"wifi"==window.networkType&&(n=Math.max(.5*e,n));
